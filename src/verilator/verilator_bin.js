...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'verilator_bin.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('verilator_bin.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  /** @type {function(...*):?} */
  function _pthread_getaffinity_np(
  ) {
  err('missing function: pthread_getaffinity_np'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "pthread_getaffinity_np": _pthread_getaffinity_np,
